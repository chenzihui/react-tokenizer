...
var SimpleExample = _interopRequire(require("./SimpleExample"));

var CustomTokenCellRendererExample = _interopRequire(require("./CustomTokenCellRendererExample"));
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "li",
          null,
          "Enter in text, followed by the 'enter', 'tab', or 'comma' keys"
        ),
        React.createElement(
          "li",
          null,
          "Delete tokens using the 'backspace' key"
        ),
        React.createElement(
          "li",
          null,
          "Paste a list of items delimited by line breaks"
        ),
        React.createElement(
          "li",
          null,
          "Input the string \"magic-input\""
        )
      ),
      React.createElement(SimpleExample, null),
      React.createElement(CustomTokenCellRendererExample, null)
    );
  }
});
...
},{"../../src/TokenCell":162,"../../src/Tokenizer":163,"./CustomTokenCellRendererExample":2,"./SimpleExample":3,"react":161}],2:[function(require,module,exports){
"use strict";
...
var TokenList = _interopRequire(require("./TokenList"));

module.exports = React.createClass({
  displayName: "CustomTokenCellRendererExample",
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        " function to customize your token cells as you wish"
      ),
  ...
  _customTokenCellRenderer: function _customTokenCellRenderer(token, index) {
    return React.createElement(
      "div",
      { className: "rt-cell custom-cell", key: index },
      "Hello: ",
      React.createElement(
        "p",
      ...
      React.createElement(
        "span",
        { className: "rt-cell__delete", onClick: this._handleCustomTokenCellClick },
        "×"
      )
    );
  },

  _handleCustomTokenCellClick: function _handleCustomTokenCellClick(evt) {
    evt.preventDefault();
    evt.stopPropagation();
...
},{"../../src/TokenCell":162,"../../src/Tokenizer":163,"./TokenList":4,"react":161}],3:[function(require,module,exports){
"use strict";
...
},{"../../src/TokenCell":162,"../../src/Tokenizer":163,"./TokenList":4,"react":161}],4:[function(require,module,exports){
"use strict";
...
var AutosizeInput = _interopRequire(require("react-input-autosize"));
  ...
  render: function render() {
    ...
    var tokens = self.props.tokens.map(function (token, index) {
      if (self.props.tokenCellRenderer) {
        ...
        return React.createElement(TokenCell, { key: index, textContent: token, removeToken: self.props.removeToken });
      }
    });
...
},{"./TokenCell":162,"react":161,"react-input-autosize":6}]},{},[1]);
